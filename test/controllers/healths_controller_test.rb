...
class HealthsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create health" do
    assert_difference('Health.count') do
      post healths_url, params: { health: { body_weight: @health.body_weight, condition: @health.condition, date: @health.date } }
    end
  ...
  test "should update health" do
    patch health_url(@health), params: { health: { body_weight: @health.body_weight, condition: @health.condition, date: @health.date } }
