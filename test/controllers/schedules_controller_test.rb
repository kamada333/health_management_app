...
class SchedulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create schedule" do
    assert_difference('Schedule.count') do
      post schedules_url, params: { schedule: { name: @schedule.name, start_time: @schedule.start_time } }
    end
  ...
  test "should update schedule" do
    patch schedule_url(@schedule), params: { schedule: { name: @schedule.name, start_time: @schedule.start_time } }
